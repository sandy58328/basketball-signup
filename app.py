...
def load_css():
    ...
    .header-box {
        ...
        text-align: center; margin-bottom: 20px; padding: 2rem 1rem 1.5rem;
        box-shadow: 0 4px 20px rgba(0,0,0,0.1); border: 1px solid #f1f5f9;
    }
    .header-bg {
        position: absolute; inset: 0;
        background-size: cover; background-position: center;
        filter: brightness(0.32) saturate(0.7); z-index: 0;
    }
    .header-content { position: relative; z-index: 1; }
    .header-title { font-size: 1.6rem; font-weight: 900; color: white !important; letter-spacing: 1px; margin-bottom: 5px; text-shadow: 0 2px 8px rgba(0,0,0,0.4); }
...
st.markdown(
    ...
    '<div class="header-bg" style="background-image:url(\'data:image/png;base64,' + LOGO_B64 + '\');"></div>'
