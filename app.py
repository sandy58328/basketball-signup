...
if st.session_state.get('success_page'):
    ...
    <style>
    @keyframes fly {
        0%   { left: 5%; top: 80%; transform: rotate(0deg); opacity: 1; }
        60%  { left: 55%; top: 15%; transform: rotate(360deg); opacity: 1; }
        80%  { left: 68%; top: 28%; transform: rotate(480deg); opacity: 1; }
        100% { left: 68%; top: 42%; transform: rotate(540deg); opacity: 0; }
    }
    ...
    #bk-wrap {
        ...
        animation: fadeout 0.5s 2.8s forwards;
        pointer-events: none;
    }
    #bk-ball {
        position: absolute; font-size: 52px; line-height: 1;
        animation: fly 1.8s cubic-bezier(0.25,0.46,0.45,0.94) forwards;
    }
    #bk-hoop {
    ...
    #bk-msg {
        ...
        white-space: nowrap;
        animation: fadein 0.4s 1.8s cubic-bezier(0.34,1.56,0.64,1) forwards;
        opacity: 0;
    }
    </style>
    <div id='bk-wrap'>
